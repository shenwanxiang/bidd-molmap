...
1. install [rdkit](http://www.rdkit.org/docs/Install.html) and [tamp](https://tmap.gdb.tools/index.html#support) first:
```bash
...
```bash
pip install deepchem==2.4.0rc1.dev20200902023007
```
