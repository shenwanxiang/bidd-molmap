...
task_name = 'pdb_bind_full'
tasks = ['-logKd/Ki']

raw_filename = "./pdb_bind_full.csv"
...
train_df = remained_df[remained_df['group'] == 'train']
valid_df = remained_df[remained_df['group'] == 'valid']
test_df =  remained_df[remained_df['group'] == 'test']
...
if __name__ == '__main__': 
    ...
    pd.DataFrame(results).to_csv('../results_attentivefp/results_AttentiveFP.csv')
